...
export default function GeneralSearcher({onChannelsSearched, onSearching = () => {}, onFilterChanged = ()=>{}}: GeneralSearcherProps){
    ...
    const [channelsSearch, setChannelsSearch] = React.useState<GetManyByNameOrIdRequest >({
        channelId: null,
        channelName: null
    });
    ...
    useEffect(() => {
        ...
        searchById ? setChannelsSearch((prev) => ({ ...prev, channelId: filter, channelName: null })) :
        setChannelsSearch((prev) => ({ ...prev, channelId: null, channelName: filter }));
    ...
    return(
                <SearchBar searchButton={true} maxLength={100} placeholder="Search something..."  onSearch={(value) => {setFilter(value);}} /> 
