...
export default function ChannelsContainer({
  ...
  if (!isMounted) {
    ...
    return (
      ...
      >
        <button
          className={` shrink-0 ${layout.sideBarExpanded ? "size-[50px]" : "size-[28px]"} shrink-0 rounded-full bg-neutral-100 dark:bg-neutral-900 items-center justify-center flex hover:text-white hover:bg-blue-500 dark:hover:bg-blue-700 transition-all`}
          onClick={() =>
            setLayout({
