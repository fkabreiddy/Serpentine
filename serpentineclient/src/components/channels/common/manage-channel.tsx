            ...
            <div className="flex flex-col gap-4 w-full max-sm:w-[80%] max-md:mt-8 max-md:pb-4">
              ...
              <div className="flex w-full gap-2 items-start justify-between">
                <div className="flex flex-col max-w-[70%]">
                  ...
                  <p className="opacity-50 whitespace-nowrap overflow-hidden text-ellipsis max-w-full mt-1 text-[10px] font-normal">
                    id.{channel?.id}
                  </p>
                </div>
              ...
              <div className="w-full" id={"channel-description-container"}>
                <p
                  style={{ height: showMoreDescription ? "auto" : "60px" }}
                  className="w-full font-normal opacity-80 text-[13px] whitespace-pre-line  text-ellipsis overflow-hidden "
                >
