    ...
    <div className="flex flex-col gap-4 w-full max-sm:w-[80%] max-md:mt-8 max-md:pb-4">
      ...
      >
        <div className="flex flex-col w-full gap-2 relative mt-2 mb-2">
          ...
          {watch("coverPictureFile") ? (
            <CoverAvatar file={watch("coverPictureFile") as FileType} />
          ) : (
            <Avatar
              className="transition-all absolute border-white border-3 dark:border-black rounded-full -bottom-[10px] right-[30px]"
              name={watch("name") !== "" ? watch("name") : "awesomechannel"}
              size={60}
              variant="marble"
            />
          )}
        ...
        <div className="flex items-center gap-2 mb-4">
          <IconButton
            ...
            tooltipText={"Change cover picture"}
            className="bg-default-100/80 hover:bg-default-100/90 dark:bg-neutral-950/80 dark:hover:bg-neutral-950/90"
          >
            <ImageIcon
