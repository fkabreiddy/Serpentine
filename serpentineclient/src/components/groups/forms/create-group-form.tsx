...
import {CreateGroupRequest, createGroupSchema} from "@/models/requests/groups/create-group-request.ts";
    ...
    return(
        <>
            ...
            <form onSubmit={handleSubmit(data => submit(data))}   className="w-full relative  flex flex-col gap-3 mt-4">
                ...
                <Checkbox isSelected={watch("public")} {...register("public")} size="sm">
                    Is Public
                </Checkbox>
                <p className="text-xs opacity-45">If public every member of this channel can post on it.</p>
