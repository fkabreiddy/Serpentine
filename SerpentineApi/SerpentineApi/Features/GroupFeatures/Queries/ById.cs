...
internal class GetByIdEndpoint : IEndpoint
{
    ...
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapGet(
            ...
            .WithDescription(
                "Returns a group with a certain Id. Requires Authorization. Requires CORS."
            )
            .WithName(nameof(GetByIdEndpoint));
    }
}

internal class GetByIdEndpointHandler(SerpentineDbContext context)
    : IEndpointHandler<GetByIdRequest, OneOf<GroupResponse, Failure>>
{
    ...
    {
        var response = await context.Groups.GetGroupWithJustMyAccessByGroupId(
            request.GroupId,
