using System.Text.Json.Serialization;
        ...
        internal class UpdateGroupAccessEndpointHandler : IEndpointHandler<UpdateGroupAccessRequest, OneOf<GroupAccessResponse, Failure>>
        {
            public async Task<OneOf<GroupAccessResponse, Failure>> HandleAsync(UpdateGroupAccessRequest request, CancellationToken cancellationToken = default)
            {
