...
using Microsoft.EntityFrameworkCore;
        ...
        public class GetCountUnreadMessagesRequest : RequestWithUserCredentials, IRequest<OneOf<int, Failure>>
        {
            [FromQuery(Name = "groupId"), JsonPropertyName("groupId"), Description("The group where messages are going to be trieved"), Required]
            public Ulid GroupId { get; set; }
                
    
        }

        public class GetCountUnreadMessagesRequestValidator : AbstractValidator<GetCountUnreadMessagesRequest>
        {
        ...
        internal class GetCountUnreadMessagesEndpoint : IEndpoint
        {
            ...
            public void MapEndpoint(IEndpointRouteBuilder app)
            {
                ...
                .Experimental()
                .WithOpenApi()
                .WithDescription("Returns a number of unread messages by an user id from a group. Requires Authorization. \n Requires CORS.")
        ...
        internal class GetCountUnreadMessagesEndpointHandler(SerpentineDbContext context) : IEndpointHandler<GetCountUnreadMessagesRequest, OneOf<int, Failure>>
        {
