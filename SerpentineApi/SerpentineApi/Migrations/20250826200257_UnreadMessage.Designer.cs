...
namespace SerpentineApi.Migrations
{
    ...
    [Migration("20250826200257_UnreadMessage")]
            ...
            modelBuilder.Entity("SerpentineApi.DataAccess.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessLevel = 0,
                            CreatedAt = new DateTime(2025, 8, 26, 20, 2, 55, 244, DateTimeKind.Utc).AddTicks(3965),
                            Name = "User",
                            UpdatedAt = new DateTime(2025, 8, 26, 20, 2, 55, 244, DateTimeKind.Utc).AddTicks(3969)
                        },
                        new
                        {
                            Id = "01K1Y24KEPDA7ZFCX6YCP3MY7M",
                            AccessLevel = 1,
                            CreatedAt = new DateTime(2025, 8, 26, 20, 2, 55, 248, DateTimeKind.Utc).AddTicks(535),
                            Name = "Admin",
                            UpdatedAt = new DateTime(2025, 8, 26, 20, 2, 55, 248, DateTimeKind.Utc).AddTicks(535)
                        },
                        new
                        {
                            Id = "01K1Y24KEPTCVKR97AKSWKHTP8",
                            AccessLevel = 2,
                            CreatedAt = new DateTime(2025, 8, 26, 20, 2, 55, 248, DateTimeKind.Utc).AddTicks(561),
                            Name = "Tester",
                            UpdatedAt = new DateTime(2025, 8, 26, 20, 2, 55, 248, DateTimeKind.Utc).AddTicks(561)
                        },
                        new
                        {
                            Id = "01K1Y24KEP473CNR8N01ZCXRV9",
                            AccessLevel = 3,
                            CreatedAt = new DateTime(2025, 8, 26, 20, 2, 55, 248, DateTimeKind.Utc).AddTicks(571),
                            Name = "Developer",
                            UpdatedAt = new DateTime(2025, 8, 26, 20, 2, 55, 248, DateTimeKind.Utc).AddTicks(571)
                        });
                });
